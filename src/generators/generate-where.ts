...
import { SimpleQueyOperator } from '../interfaces/simple-quey-operator';
...
export function generateWhere<T>(
    ...
    const conjunction = (pureWhereGenerated ? pureWhereGenerated.conjunction as string : 'and');
    return generateWhereQuery(query, pureWhereGenerated as PureWhereInterface, conjunction);
}
